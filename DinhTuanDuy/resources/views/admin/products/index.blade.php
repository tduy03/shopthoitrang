    ...
    <table class="table table-bordered">
        <thead>
            <tr>
                ...
                <th>Quantity</th>
                <th>Category</th>
                <th>Production Date</th> <!-- Thêm cột cho Production Date -->
                <th>Image</th>
                <th>Action</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($products as $product)
                <tr>
                    ...
                    <td>{{ $product->production_date ? \Carbon\Carbon::parse($product->production_date)->format('Y-m-d') : 'N/A' }}</td> <!-- Hiển thị ngày sản xuất -->
                    <td>
                        @if($product->image)
